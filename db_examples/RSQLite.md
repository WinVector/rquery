...
```
    ...
    ## [1] "table(ex_16756522157928277604_0000000002; subjectID, diagnosis, probability)"
...
```
    ...
    ## $ex_16756522157928277604_0000000000
    ...
    ## 
    ## $ex_16756522157928277604_0000000001
    ## [1] "table(ex_16756522157928277604_0000000000; subjectID, surveyCategory, assessmentTotal, irrelevantCol1, irrelevantCol2, probability) %.>% natural_join(., table(ex_16756522157928277604_0000000000; subjectID, surveyCategory, assessmentTotal, irrelevantCol1, irrelevantCol2, probability) %.>% project(., tot_prob := sum(probability), g= subjectID), j= LEFT, by= subjectID) %.>% extend(., probability := probability / tot_prob)"
    ## 
    ## $ex_16756522157928277604_0000000002
    ## [1] "table(ex_16756522157928277604_0000000001; subjectID, surveyCategory, assessmentTotal, irrelevantCol1, irrelevantCol2, probability, tot_prob) %.>% project(., probability := max(probability), g= subjectID) %.>% natural_join(., table(ex_16756522157928277604_0000000001; subjectID, surveyCategory, assessmentTotal, irrelevantCol1, irrelevantCol2, probability, tot_prob), j= INNER, by= subjectID, probability) %.>% project(., probability := max(probability), surveyCategory := min(surveyCategory), g= subjectID) %.>% rename(., c('diagnosis' = 'surveyCategory')) %.>% select_columns(., subjectID, diagnosis, probability) %.>% orderby(., subjectID)"
...
```
    ...
    ##   FROM
    ##    `d`
    ##   ) tsql_62600917277394868159_0000000000
    ## ) tsql_62600917277394868159_0000000001
    ## ;
    ## 
    ## 
    ## -- ex_16756522157928277604_0000000001
    ...
    ##  FROM (
    ##   SELECT
    ##    COALESCE(`tsql_30213784054071853848_0000000001`.`subjectID`, `tsql_30213784054071853848_0000000002`.`subjectID`) AS `subjectID`,
    ##    `tsql_30213784054071853848_0000000001`.`surveyCategory` AS `surveyCategory`,
    ##    `tsql_30213784054071853848_0000000001`.`probability` AS `probability`,
    ##    `tsql_30213784054071853848_0000000002`.`tot_prob` AS `tot_prob`
    ##   FROM (
    ##    SELECT
    ##     `subjectID`,
    ##     `surveyCategory`,
    ...
    ##    FROM
    ##     `ex_16756522157928277604_0000000000`
    ##   ) `tsql_30213784054071853848_0000000001`
    ##   LEFT JOIN (
    ...
    ##     FROM
    ##      `ex_16756522157928277604_0000000000`
    ##     ) tsql_30213784054071853848_0000000000
    ##    GROUP BY
    ##     `subjectID`
    ##   ) `tsql_30213784054071853848_0000000002`
    ##   ON
    ##    `tsql_30213784054071853848_0000000001`.`subjectID` = `tsql_30213784054071853848_0000000002`.`subjectID`
    ##   ) tsql_30213784054071853848_0000000003
    ## ) tsql_30213784054071853848_0000000004
    ## ;
    ## 
    ## 
    ## -- ex_16756522157928277604_0000000002
    ...
    ##     SELECT
    ##      COALESCE(`tsql_86163250344221304400_0000000001`.`subjectID`, `tsql_86163250344221304400_0000000002`.`subjectID`) AS `subjectID`,
    ##      COALESCE(`tsql_86163250344221304400_0000000001`.`probability`, `tsql_86163250344221304400_0000000002`.`probability`) AS `probability`,
    ##      `tsql_86163250344221304400_0000000002`.`surveyCategory` AS `surveyCategory`
    ##     FROM (
    ...
    ##       FROM
    ##        `ex_16756522157928277604_0000000001`
    ##       ) tsql_86163250344221304400_0000000000
    ##      GROUP BY
    ##       `subjectID`
    ##     ) `tsql_86163250344221304400_0000000001`
    ##     INNER JOIN (
    ##      SELECT
    ##       `subjectID`,
    ##       `surveyCategory`,
    ...
    ##      FROM
    ##       `ex_16756522157928277604_0000000001`
    ##     ) `tsql_86163250344221304400_0000000002`
    ##     ON
    ##      `tsql_86163250344221304400_0000000001`.`subjectID` = `tsql_86163250344221304400_0000000002`.`subjectID` AND `tsql_86163250344221304400_0000000001`.`probability` = `tsql_86163250344221304400_0000000002`.`probability`
    ##     ) tsql_86163250344221304400_0000000003
    ##    GROUP BY
    ##     `subjectID`
    ##   ) tsql_86163250344221304400_0000000004
    ##  ) tsql_86163250344221304400_0000000005
    ## ) tsql_86163250344221304400_0000000006 ORDER BY `subjectID`
    ## ;
