...
```
    ...
    ## [1] "table(ex_43021046251906518448_0000000002; subjectID, diagnosis, probability)"
...
```
    ...
    ## $ex_43021046251906518448_0000000000
...
```
    ...
    ##   FROM
    ##    `d`
    ##   ) tsql_78931925016303243006_0000000000
    ## ) tsql_78931925016303243006_0000000001
    ## ;
    ## 
    ## 
    ## -- ex_43021046251906518448_0000000001
    ...
    ##  FROM (
    ##   SELECT
    ##    COALESCE(`tsql_32612469639948407699_0000000001`.`subjectID`, `tsql_32612469639948407699_0000000002`.`subjectID`) AS `subjectID`,
    ##    `tsql_32612469639948407699_0000000001`.`surveyCategory` AS `surveyCategory`,
    ##    `tsql_32612469639948407699_0000000001`.`probability` AS `probability`,
    ##    `tsql_32612469639948407699_0000000002`.`tot_prob` AS `tot_prob`
    ##   FROM (
    ##    SELECT
    ##     `subjectID`,
    ##     `surveyCategory`,
    ...
    ##    FROM
    ##     `ex_43021046251906518448_0000000000`
    ##   ) `tsql_32612469639948407699_0000000001`
    ##   LEFT JOIN (
    ...
    ##     FROM
    ##      `ex_43021046251906518448_0000000000`
    ##     ) tsql_32612469639948407699_0000000000
    ##    GROUP BY
    ##     `subjectID`
    ##   ) `tsql_32612469639948407699_0000000002`
    ##   ON
    ##    `tsql_32612469639948407699_0000000001`.`subjectID` = `tsql_32612469639948407699_0000000002`.`subjectID`
    ##   ) tsql_32612469639948407699_0000000003
    ## ) tsql_32612469639948407699_0000000004
    ## ;
    ## 
    ## 
    ## -- ex_43021046251906518448_0000000002
    ...
    ##     SELECT
    ##      COALESCE(`tsql_22954152272155337056_0000000001`.`subjectID`, `tsql_22954152272155337056_0000000002`.`subjectID`) AS `subjectID`,
    ##      COALESCE(`tsql_22954152272155337056_0000000001`.`probability`, `tsql_22954152272155337056_0000000002`.`probability`) AS `probability`,
    ##      `tsql_22954152272155337056_0000000002`.`surveyCategory` AS `surveyCategory`
    ##     FROM (
    ...
    ##       FROM
    ##        `ex_43021046251906518448_0000000001`
    ##       ) tsql_22954152272155337056_0000000000
    ##      GROUP BY
    ##       `subjectID`
    ##     ) `tsql_22954152272155337056_0000000001`
    ##     INNER JOIN (
    ##      SELECT
    ##       `subjectID`,
    ##       `surveyCategory`,
    ...
    ##      FROM
    ##       `ex_43021046251906518448_0000000001`
    ##     ) `tsql_22954152272155337056_0000000002`
    ##     ON
    ##      `tsql_22954152272155337056_0000000001`.`subjectID` = `tsql_22954152272155337056_0000000002`.`subjectID` AND `tsql_22954152272155337056_0000000001`.`probability` = `tsql_22954152272155337056_0000000002`.`probability`
    ##     ) tsql_22954152272155337056_0000000003
    ##    GROUP BY
    ##     `subjectID`
    ##   ) tsql_22954152272155337056_0000000004
    ##  ) tsql_22954152272155337056_0000000005
    ## ) tsql_22954152272155337056_0000000006 ORDER BY `subjectID`
    ## ;
