...
```
    ...
    ## [1] "table(ex_16825930219866949820_0000000002; subjectID, diagnosis, probability)"
...
```
    ...
    ## $ex_16825930219866949820_0000000000
...
```
    ...
    ##   FROM
    ##    `d`
    ##   ) tsql_34190373137490324003_0000000000
    ## ) tsql_34190373137490324003_0000000001
    ## ;
    ## 
    ## 
    ## -- ex_16825930219866949820_0000000001
    ...
    ##  FROM (
    ##   SELECT
    ##    COALESCE(`tsql_87503219082667560468_0000000001`.`subjectID`, `tsql_87503219082667560468_0000000002`.`subjectID`) AS `subjectID`,
    ##    `tsql_87503219082667560468_0000000001`.`surveyCategory` AS `surveyCategory`,
    ##    `tsql_87503219082667560468_0000000001`.`probability` AS `probability`,
    ##    `tsql_87503219082667560468_0000000002`.`tot_prob` AS `tot_prob`
    ##   FROM (
    ##    SELECT
    ##     `subjectID`,
    ##     `surveyCategory`,
    ...
    ##    FROM
    ##     `ex_16825930219866949820_0000000000`
    ##   ) `tsql_87503219082667560468_0000000001`
    ##   LEFT JOIN (
    ...
    ##     FROM
    ##      `ex_16825930219866949820_0000000000`
    ##     ) tsql_87503219082667560468_0000000000
    ##    GROUP BY
    ##     `subjectID`
    ##   ) `tsql_87503219082667560468_0000000002`
    ##   ON
    ##    `tsql_87503219082667560468_0000000001`.`subjectID` = `tsql_87503219082667560468_0000000002`.`subjectID`
    ##   ) tsql_87503219082667560468_0000000003
    ## ) tsql_87503219082667560468_0000000004
    ## ;
    ## 
    ## 
    ## -- ex_16825930219866949820_0000000002
    ...
    ##     SELECT
    ##      COALESCE(`tsql_47936766015150898123_0000000001`.`subjectID`, `tsql_47936766015150898123_0000000002`.`subjectID`) AS `subjectID`,
    ##      COALESCE(`tsql_47936766015150898123_0000000001`.`probability`, `tsql_47936766015150898123_0000000002`.`probability`) AS `probability`,
    ##      `tsql_47936766015150898123_0000000002`.`surveyCategory` AS `surveyCategory`
    ##     FROM (
    ...
    ##       FROM
    ##        `ex_16825930219866949820_0000000001`
    ##       ) tsql_47936766015150898123_0000000000
    ##      GROUP BY
    ##       `subjectID`
    ##     ) `tsql_47936766015150898123_0000000001`
    ##     INNER JOIN (
    ##      SELECT
    ##       `subjectID`,
    ##       `surveyCategory`,
    ...
    ##      FROM
    ##       `ex_16825930219866949820_0000000001`
    ##     ) `tsql_47936766015150898123_0000000002`
    ##     ON
    ##      `tsql_47936766015150898123_0000000001`.`subjectID` = `tsql_47936766015150898123_0000000002`.`subjectID` AND `tsql_47936766015150898123_0000000001`.`probability` = `tsql_47936766015150898123_0000000002`.`probability`
    ##     ) tsql_47936766015150898123_0000000003
    ##    GROUP BY
    ##     `subjectID`
    ##   ) tsql_47936766015150898123_0000000004
    ##  ) tsql_47936766015150898123_0000000005
    ## ) tsql_47936766015150898123_0000000006 ORDER BY `subjectID`
    ## ;
