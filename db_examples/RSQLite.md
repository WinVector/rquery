...
```
    ...
    ## [1] "table(ex_85648000929775952175_0000000002; subjectID, diagnosis, probability)"
...
```
    ...
    ## $ex_85648000929775952175_0000000000
    ...
    ## 
    ## $ex_85648000929775952175_0000000001
    ## [1] "table(ex_85648000929775952175_0000000000; subjectID, surveyCategory, assessmentTotal, irrelevantCol1, irrelevantCol2, probability) %.>% natural_join(., table(ex_85648000929775952175_0000000000; subjectID, surveyCategory, assessmentTotal, irrelevantCol1, irrelevantCol2, probability) %.>% project(., tot_prob := sum(probability), g= subjectID), j= LEFT, by= subjectID) %.>% extend(., probability := probability / tot_prob)"
    ## 
    ## $ex_85648000929775952175_0000000002
    ## [1] "table(ex_85648000929775952175_0000000001; subjectID, surveyCategory, assessmentTotal, irrelevantCol1, irrelevantCol2, probability, tot_prob) %.>% project(., probability := max(probability), g= subjectID) %.>% natural_join(., table(ex_85648000929775952175_0000000001; subjectID, surveyCategory, assessmentTotal, irrelevantCol1, irrelevantCol2, probability, tot_prob), j= INNER, by= subjectID, probability) %.>% project(., probability := max(probability), surveyCategory := min(surveyCategory), g= subjectID) %.>% rename(., c('diagnosis' = 'surveyCategory')) %.>% select_columns(., subjectID, diagnosis, probability) %.>% orderby(., subjectID)"
...
```
    ...
    ##   FROM
    ##    `d`
    ##   ) tsql_09614372202402148033_0000000000
    ## ) tsql_09614372202402148033_0000000001
    ## ;
    ## 
    ## 
    ## -- ex_85648000929775952175_0000000001
    ...
    ##  FROM (
    ##   SELECT
    ##    COALESCE(`tsql_98338647929442145722_0000000001`.`subjectID`, `tsql_98338647929442145722_0000000002`.`subjectID`) AS `subjectID`,
    ##    `tsql_98338647929442145722_0000000001`.`surveyCategory` AS `surveyCategory`,
    ##    `tsql_98338647929442145722_0000000001`.`probability` AS `probability`,
    ##    `tsql_98338647929442145722_0000000002`.`tot_prob` AS `tot_prob`
    ##   FROM (
    ##    SELECT
    ##     `subjectID`,
    ##     `surveyCategory`,
    ...
    ##    FROM
    ##     `ex_85648000929775952175_0000000000`
    ##   ) `tsql_98338647929442145722_0000000001`
    ##   LEFT JOIN (
    ...
    ##     FROM
    ##      `ex_85648000929775952175_0000000000`
    ##     ) tsql_98338647929442145722_0000000000
    ##    GROUP BY
    ##     `subjectID`
    ##   ) `tsql_98338647929442145722_0000000002`
    ##   ON
    ##    `tsql_98338647929442145722_0000000001`.`subjectID` = `tsql_98338647929442145722_0000000002`.`subjectID`
    ##   ) tsql_98338647929442145722_0000000003
    ## ) tsql_98338647929442145722_0000000004
    ## ;
    ## 
    ## 
    ## -- ex_85648000929775952175_0000000002
    ...
    ##     SELECT
    ##      COALESCE(`tsql_30593804820467472454_0000000001`.`subjectID`, `tsql_30593804820467472454_0000000002`.`subjectID`) AS `subjectID`,
    ##      COALESCE(`tsql_30593804820467472454_0000000001`.`probability`, `tsql_30593804820467472454_0000000002`.`probability`) AS `probability`,
    ##      `tsql_30593804820467472454_0000000002`.`surveyCategory` AS `surveyCategory`
    ##     FROM (
    ...
    ##       FROM
    ##        `ex_85648000929775952175_0000000001`
    ##       ) tsql_30593804820467472454_0000000000
    ##      GROUP BY
    ##       `subjectID`
    ##     ) `tsql_30593804820467472454_0000000001`
    ##     INNER JOIN (
    ##      SELECT
    ##       `subjectID`,
    ##       `surveyCategory`,
    ...
    ##      FROM
    ##       `ex_85648000929775952175_0000000001`
    ##     ) `tsql_30593804820467472454_0000000002`
    ##     ON
    ##      `tsql_30593804820467472454_0000000001`.`subjectID` = `tsql_30593804820467472454_0000000002`.`subjectID` AND `tsql_30593804820467472454_0000000001`.`probability` = `tsql_30593804820467472454_0000000002`.`probability`
    ##     ) tsql_30593804820467472454_0000000003
    ##    GROUP BY
    ##     `subjectID`
    ##   ) tsql_30593804820467472454_0000000004
    ##  ) tsql_30593804820467472454_0000000005
    ## ) tsql_30593804820467472454_0000000006 ORDER BY `subjectID`
    ## ;
