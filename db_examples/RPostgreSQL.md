...
```
    ...
    ## [1] "table(\"rquery_mat_18479058554529439653_0000000000\"; subjectID, diagnosis, probability)"
        ...
        FROM (
         ...
         FROM (
          ...
          FROM (
           ...
           FROM
            "d" LIMIT 1000
           ) tsql_00072207663540813466_0000000000
          ) tsql_00072207663540813466_0000000001
         ) tsql_00072207663540813466_0000000002
       ) tsql_00072207663540813466_0000000003
       WHERE "row_number" <= 1
      ) tsql_00072207663540813466_0000000004
     ) tsql_00072207663540813466_0000000005
    ) tsql_00072207663540813466_0000000006 ORDER BY "subjectID"
