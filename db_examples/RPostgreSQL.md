...
```
    ...
    ## [1] "table(\"rquery_mat_73287968038731070148_0000000000\"; subjectID, diagnosis, probability)"
        ...
        FROM (
         ...
         FROM (
          ...
          FROM (
           ...
           FROM
            "d" LIMIT 1000
           ) tsql_29662958632162760077_0000000000
          ) tsql_29662958632162760077_0000000001
         ) tsql_29662958632162760077_0000000002
       ) tsql_29662958632162760077_0000000003
       WHERE "row_number" <= 1
      ) tsql_29662958632162760077_0000000004
     ) tsql_29662958632162760077_0000000005
    ) tsql_29662958632162760077_0000000006 ORDER BY "subjectID"
...
![](https://github.com/WinVector/rquery/raw/master/db_examples/RPostgreSQL_diagram.png)
