...
```
    ...
    ## [1] "table(\"rquery_mat_87164928435262397709_0000000000\"; subjectID, diagnosis, probability)"
      ...
      FROM (
       SELECT * FROM (
        ...
        FROM (
         ...
         FROM (
          SELECT
           COALESCE("tsql_65745813675232513320_0000000003"."subjectID", "tsql_65745813675232513320_0000000004"."subjectID") AS "subjectID",
           "tsql_65745813675232513320_0000000003"."surveyCategory" AS "surveyCategory",
           "tsql_65745813675232513320_0000000003"."probability" AS "probability",
           "tsql_65745813675232513320_0000000004"."tot_prob" AS "tot_prob"
          FROM (
           SELECT
            "subjectID",
            "surveyCategory",
           ...
           FROM (
            ...
            FROM
             "d" LIMIT 1000
            ) tsql_65745813675232513320_0000000000
          ) "tsql_65745813675232513320_0000000003"
          LEFT JOIN (
           SELECT "subjectID", sum ( "probability" ) AS "tot_prob" FROM (
            ...
            FROM (
             ...
             FROM
              "d" LIMIT 1000
             ) tsql_65745813675232513320_0000000001
            ) tsql_65745813675232513320_0000000002
           GROUP BY
            "subjectID"
          ) "tsql_65745813675232513320_0000000004"
          ON
           "tsql_65745813675232513320_0000000003"."subjectID" = "tsql_65745813675232513320_0000000004"."subjectID"
          ) tsql_65745813675232513320_0000000005
         ) tsql_65745813675232513320_0000000006
       ) tsql_65745813675232513320_0000000007
       WHERE "row_number" <= 1
      ) tsql_65745813675232513320_0000000008
     ) tsql_65745813675232513320_0000000009
    ) tsql_65745813675232513320_0000000010 ORDER BY "subjectID"
...
The warning of repeated work (also indicated by the gold note-boxes), is in this case ignorible as it isn't a lot of work. More examples on dealing with this sort of query explosion can be found [here](https://github.com/WinVector/rquery/blob/master/db_examples/RPostgreSQL.md), [here](https://github.com/WinVector/rquery/blob/master/extras/query_growth/query_growth.md), and [here](https://github.com/WinVector/rquery/blob/master/extras/query_growth/time_dag.md).
