...
```
    ...
    ## [1] "table(\"rquery_mat_11135242207368066146_0000000000\"; subjectID, diagnosis, probability)"
      ...
      FROM (
       SELECT * FROM (
        ...
        FROM (
         ...
         FROM (
          SELECT
           COALESCE("tsql_70935435662140653427_0000000003"."subjectID", "tsql_70935435662140653427_0000000004"."subjectID") AS "subjectID",
           "tsql_70935435662140653427_0000000003"."surveyCategory" AS "surveyCategory",
           "tsql_70935435662140653427_0000000003"."probability" AS "probability",
           "tsql_70935435662140653427_0000000004"."tot_prob" AS "tot_prob"
          FROM (
           SELECT
            "subjectID",
            "surveyCategory",
           ...
           FROM (
            ...
            FROM
             "d" LIMIT 1000
            ) tsql_70935435662140653427_0000000000
          ) "tsql_70935435662140653427_0000000003"
          LEFT JOIN (
           SELECT "subjectID", sum ( "probability" ) AS "tot_prob" FROM (
            ...
            FROM (
             ...
             FROM
              "d" LIMIT 1000
             ) tsql_70935435662140653427_0000000001
            ) tsql_70935435662140653427_0000000002
           GROUP BY
            "subjectID"
          ) "tsql_70935435662140653427_0000000004"
          ON
           "tsql_70935435662140653427_0000000003"."subjectID" = "tsql_70935435662140653427_0000000004"."subjectID"
          ) tsql_70935435662140653427_0000000005
         ) tsql_70935435662140653427_0000000006
       ) tsql_70935435662140653427_0000000007
       WHERE "row_number" <= 1
      ) tsql_70935435662140653427_0000000008
     ) tsql_70935435662140653427_0000000009
    ) tsql_70935435662140653427_0000000010 ORDER BY "subjectID"
