...
Please take careful note what is marked as "`__IDENTIFIER__`", versus what is marked as "`__STRING_CONSTANT__`".
...
# bquote substitution on name type: col_string 
