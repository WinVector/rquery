...
Additional function re-mappings can be specified by user code.  One such example is re-writing `as.Date(x)` as `to_date(date, "YYYY-MM-DD")` as seen in an example [here](https://github.com/WinVector/rquery/blob/master/db_examples/RPostgres_date.md).
