...
Ad Hoc mode is implemented on top of `wrapr::%.>%` using a few fine 
points of `R` programming:
...
`as.data.frame()`, `print()` and `head()` for our `rquery::"relop"` operator trees / pipelines.
