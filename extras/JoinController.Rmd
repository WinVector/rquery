...
This note (an update of [our 2017 article](http://www.win-vector.com/blog/2017/06/use-a-join-controller-to-document-your-work/)) and describes a useful tool we call a "join controller" (we discuss this further in our [dependency sorting note](https://github.com/WinVector/rquery/blob/master/extras/DependencySorting.md)).
