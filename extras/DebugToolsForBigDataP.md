...
```
    ...
    ##     FROM
    ##      "tmp_res"
    ##   ) tsql_50318546836111037824_0000000004
    ##  ) tsql_50318546836111037824_0000000005
    ## ) tsql_50318546836111037824_0000000006 ORDER BY "subjectID"
...
```
    ...
    ## Timing stopped at: 0.011 0 0.014
...
```
    ...
    ## FROM "rquery_mat_61272338591093362458_0000000000") "preregdaop"
    ## ORDER BY "probability", "surveyCategory") "ijbeqlelek") "dyoucfcklu"
    ## WHERE ("zzz7" = "zzz8")) "jviryqftna") "sjzfzggkzc"
...
```
    ...
    ## Timing stopped at: 0.185 0.002 0.503

``` r
base::date()
```

    ## [1] "Sat Jan 12 11:48:47 2019"
...
```
    ...
    ## Timing stopped at: 0.182 0.012 38.82

``` r
base::date()
```

    ## [1] "Sat Jan 12 11:49:26 2019"
