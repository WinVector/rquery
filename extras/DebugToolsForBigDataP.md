...
```
    ...
    ## [1] "Tue May 15 11:08:41 2018"

``` r
base::date()
```

    ## [1] "Tue May 15 11:08:42 2018"
...
```
    ...
    ##        FROM (
    ##         SELECT
    ##          "rquery_mat_56859286688865083316_0000000000"."subjectID",
    ##          "rquery_mat_56859286688865083316_0000000000"."surveyCategory",
    ##          "rquery_mat_56859286688865083316_0000000000"."assessmentTotal"
    ##         FROM
    ##          "rquery_mat_56859286688865083316_0000000000"
    ##         ) tsql_81338275189883064931_0000000000
    ##        ) tsql_81338275189883064931_0000000001
    ##       ) tsql_81338275189883064931_0000000002
    ##     ) tsql_81338275189883064931_0000000003
    ##     WHERE "row_number" <= 1
    ## [1] "step 2"
    ...
    ##     FROM
    ##      "tmp_res"
    ##   ) tsql_81338275189883064931_0000000004
    ##  ) tsql_81338275189883064931_0000000005
    ## ) tsql_81338275189883064931_0000000006 ORDER BY "subjectID"
...
```
    ...
    ## Timing stopped at: 0.024 0.001 0.024
...
```
    ...
    ## FROM "rquery_mat_56859286688865083316_0000000000") "bbripgvnrk"
    ## ORDER BY "probability", "surveyCategory") "kklbxevnvd") "kntexoefkq"
    ## WHERE ("zzz7" = "zzz8")) "feoccmrpbp") "zwhfsnsktu"
...
```
    ...
    ## Timing stopped at: 0.086 0.001 0.101
...
```
    ...
    ## Timing stopped at: 0.146 0.012 43.6

``` r
base::date()
```

    ## [1] "Tue May 15 11:10:42 2018"
