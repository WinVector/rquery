...
```
    ...
    ##        FROM (
    ##         SELECT
    ##          "rquery_mat_18505497022537413465_0000000000"."subjectID",
    ##          "rquery_mat_18505497022537413465_0000000000"."surveyCategory",
    ##          "rquery_mat_18505497022537413465_0000000000"."assessmentTotal"
    ##         FROM
    ##          "rquery_mat_18505497022537413465_0000000000"
    ##         ) tsql_57873310912551389227_0000000000
    ##        ) tsql_57873310912551389227_0000000001
    ##       ) tsql_57873310912551389227_0000000002
    ##     ) tsql_57873310912551389227_0000000003
    ##     WHERE "row_number" <= 1
    ## [1] "step 2"
    ...
    ##     FROM
    ##      "tmp_res"
    ##   ) tsql_57873310912551389227_0000000004
    ##  ) tsql_57873310912551389227_0000000005
    ## ) tsql_57873310912551389227_0000000006 ORDER BY "subjectID"
...
```
    ...
    ## Timing stopped at: 0.031 0.001 0.035
...
```
    ...
    ## FROM "rquery_mat_18505497022537413465_0000000000") "zpnowzrqsc"
    ## ORDER BY "probability", "surveyCategory") "xfnsnbafmz") "wejfgllief"
    ## WHERE ("zzz7" = "zzz8")) "righamjlki") "kissajkvah"
...
```
    ...
    ## Timing stopped at: 0.112 0.003 0.135
...
```
    ...
    ## Timing stopped at: 0.202 0.155 786.8

``` r
base::date()
```

    ## [1] "Mon May 14 08:44:39 2018"
