...
```
    ...
    ## [1] "Mon May 28 11:48:03 2018"

``` r
base::date()
```

    ## [1] "Mon May 28 11:48:04 2018"
...
```
    ...
    ##        FROM (
    ##         SELECT
    ##          "rquery_mat_65562491652230780516_0000000000"."subjectID",
    ##          "rquery_mat_65562491652230780516_0000000000"."surveyCategory",
    ##          "rquery_mat_65562491652230780516_0000000000"."assessmentTotal"
    ##         FROM
    ##          "rquery_mat_65562491652230780516_0000000000"
    ##         ) tsql_37998242577778211912_0000000000
    ##        ) tsql_37998242577778211912_0000000001
    ##       ) tsql_37998242577778211912_0000000002
    ##     ) tsql_37998242577778211912_0000000003
    ##     WHERE "row_number" <= 1
    ## [1] "step 2"
    ...
    ##     FROM
    ##      "tmp_res"
    ##   ) tsql_37998242577778211912_0000000004
    ##  ) tsql_37998242577778211912_0000000005
    ## ) tsql_37998242577778211912_0000000006 ORDER BY "subjectID"
...
```
    ...
    ## FROM "rquery_mat_65562491652230780516_0000000000") "hushqolzaf"
    ## ORDER BY "probability", "surveyCategory") "mskoulzvjj") "vzernftewa"
    ## WHERE ("zzz7" = "zzz8")) "jghdpyhldy") "svmoigtgho"
...
```
    ...
    ## Timing stopped at: 0.089 0.001 0.103
...
```
    ...
    ## Timing stopped at: 0.151 0.012 41.53

``` r
base::date()
```

    ## [1] "Mon May 28 11:49:57 2018"
