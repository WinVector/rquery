...
```
    ...
    ## [1] "Tue May 15 11:36:02 2018"

``` r
base::date()
```

    ## [1] "Tue May 15 11:36:03 2018"
...
```
    ...
    ##        FROM (
    ##         SELECT
    ##          "rquery_mat_47034410998561532430_0000000000"."subjectID",
    ##          "rquery_mat_47034410998561532430_0000000000"."surveyCategory",
    ##          "rquery_mat_47034410998561532430_0000000000"."assessmentTotal"
    ##         FROM
    ##          "rquery_mat_47034410998561532430_0000000000"
    ##         ) tsql_60981860377233618641_0000000000
    ##        ) tsql_60981860377233618641_0000000001
    ##       ) tsql_60981860377233618641_0000000002
    ##     ) tsql_60981860377233618641_0000000003
    ##     WHERE "row_number" <= 1
    ## [1] "step 2"
    ...
    ##     FROM
    ##      "tmp_res"
    ##   ) tsql_60981860377233618641_0000000004
    ##  ) tsql_60981860377233618641_0000000005
    ## ) tsql_60981860377233618641_0000000006 ORDER BY "subjectID"
...
```
    ...
    ## FROM "rquery_mat_47034410998561532430_0000000000") "wbvkzokrdo"
    ## ORDER BY "probability", "surveyCategory") "kiawpfyttc") "okdaxdrfkk"
    ## WHERE ("zzz7" = "zzz8")) "tacequvccn") "prxqeysyao"
...
```
    ...
    ## Timing stopped at: 0.092 0.001 0.109
...
```
    ...
    ## Timing stopped at: 0.152 0.013 46.52

``` r
base::date()
```

    ## [1] "Tue May 15 11:38:09 2018"
