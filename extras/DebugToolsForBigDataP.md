...
```
    ...
    ##        FROM (
    ##         SELECT
    ##          "rquery_mat_69664166624860670424_0000000000"."subjectID",
    ##          "rquery_mat_69664166624860670424_0000000000"."surveyCategory",
    ##          "rquery_mat_69664166624860670424_0000000000"."assessmentTotal"
    ##         FROM
    ##          "rquery_mat_69664166624860670424_0000000000"
    ##         ) tsql_50374789878673334264_0000000000
    ##        ) tsql_50374789878673334264_0000000001
    ##       ) tsql_50374789878673334264_0000000002
    ##     ) tsql_50374789878673334264_0000000003
    ##     WHERE "row_number" <= 1
    ## [1] "step 2"
    ...
    ##     FROM
    ##      "tmp_res"
    ##   ) tsql_50374789878673334264_0000000004
    ##  ) tsql_50374789878673334264_0000000005
    ## ) tsql_50374789878673334264_0000000006 ORDER BY "subjectID"
...
```
    ...
    ## FROM "rquery_mat_69664166624860670424_0000000000") "gvabkatcds"
    ## ORDER BY "probability", "surveyCategory") "apvqpxeafq") "jwyxpgxboe"
    ## WHERE ("zzz7" = "zzz8")) "hqywpgycgh") "fzozappzgw"
...
```
    ...
    ## Timing stopped at: 0.089 0.002 0.119
