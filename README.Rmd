...
Notice the query was automatically restricted to columns actually needed from the source table.  This is possible because the `rquery` representation is an intelligible network of nodes, so we can interrogate it for
