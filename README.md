...
```
    ...
    ## [1] "table(\"rquery_mat_17466502851994988708_0000000000\"; subjectID, diagnosis, probability)"
        ...
        FROM (
         ...
         FROM (
          ...
          FROM (
           ...
           FROM
            "d" LIMIT 1000
           ) tsql_46610165364027093443_0000000000
          ) tsql_46610165364027093443_0000000001
         ) tsql_46610165364027093443_0000000002
       ) tsql_46610165364027093443_0000000003
       WHERE "row_number" <= 1
      ) tsql_46610165364027093443_0000000004
     ) tsql_46610165364027093443_0000000005
    ) tsql_46610165364027093443_0000000006 ORDER BY "subjectID"
