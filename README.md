...
```
    ...
    ## [1] "table(\"rquery_mat_35102027565011033510_0000000000\"; subjectID, diagnosis, probability)"
        ...
        FROM (
         ...
         FROM (
          ...
          FROM (
           ...
           FROM
            "d" LIMIT 1000
           ) tsql_60060520965480674884_0000000000
          ) tsql_60060520965480674884_0000000001
         ) tsql_60060520965480674884_0000000002
       ) tsql_60060520965480674884_0000000003
       WHERE "row_number" <= 1
      ) tsql_60060520965480674884_0000000004
     ) tsql_60060520965480674884_0000000005
    ) tsql_60060520965480674884_0000000006 ORDER BY "subjectID"
