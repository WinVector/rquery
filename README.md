...
```
    ...
    ## [1] "table(\"rquery_mat_44816306787947480357_0000000000\"; subjectID, diagnosis, probability)"
        ...
        FROM (
         ...
         FROM (
          ...
          FROM (
           ...
           FROM
            "d" LIMIT 1000
           ) tsql_96177395779538353754_0000000000
          ) tsql_96177395779538353754_0000000001
         ) tsql_96177395779538353754_0000000002
       ) tsql_96177395779538353754_0000000003
       WHERE "row_number" <= 1
      ) tsql_96177395779538353754_0000000004
     ) tsql_96177395779538353754_0000000005
    ) tsql_96177395779538353754_0000000006 ORDER BY "subjectID"
