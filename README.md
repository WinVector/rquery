...
```
    ...
    ## [1] "table(\"rquery_mat_87246032670026599134_0000000000\"; subjectID, diagnosis, probability)"
        ...
        FROM (
         ...
         FROM (
          ...
          FROM (
           ...
           FROM
            "d" LIMIT 1000
           ) tsql_61792966950998131216_0000000000
          ) tsql_61792966950998131216_0000000001
         ) tsql_61792966950998131216_0000000002
       ) tsql_61792966950998131216_0000000003
       WHERE "row_number" <= 1
      ) tsql_61792966950998131216_0000000004
     ) tsql_61792966950998131216_0000000005
    ) tsql_61792966950998131216_0000000006 ORDER BY "subjectID"
