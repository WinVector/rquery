...
```
    ...
    ## [1] "table(\"rquery_mat_38764345531562091110_0000000000\"; subjectID, diagnosis, probability)"
        ...
        FROM (
         ...
         FROM (
          ...
          FROM (
           ...
           FROM
            "d" LIMIT 1000
           ) tsql_96635746555315241738_0000000000
          ) tsql_96635746555315241738_0000000001
         ) tsql_96635746555315241738_0000000002
       ) tsql_96635746555315241738_0000000003
       WHERE "row_number" <= 1
      ) tsql_96635746555315241738_0000000004
     ) tsql_96635746555315241738_0000000005
    ) tsql_96635746555315241738_0000000006 ORDER BY "subjectID"
