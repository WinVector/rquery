      ...
      SELECT * FROM (
       ...
       FROM (
        ...
        FROM (
         ...
         FROM (
          SELECT * FROM "d"
         ) tsql_q5gk4ujafrp1lbe4kxtm_0000000000
        ) tsql_q5gk4ujafrp1lbe4kxtm_0000000001
       ) tsql_q5gk4ujafrp1lbe4kxtm_0000000002
      ) tsql_q5gk4ujafrp1lbe4kxtm_0000000003
      WHERE isdiagnosis
     ) tsql_q5gk4ujafrp1lbe4kxtm_0000000004
    ) tsql_q5gk4ujafrp1lbe4kxtm_0000000005 ORDER BY "subjectID"
