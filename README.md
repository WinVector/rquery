...
```
    ...
    ## [1] "table(\"rquery_mat_16153549719036371985_0000000000\"; subjectID, diagnosis, probability)"
        ...
        FROM (
         ...
         FROM (
          ...
          FROM (
           ...
           FROM
            "d" LIMIT 1000
           ) tsql_56389361563016958637_0000000000
          ) tsql_56389361563016958637_0000000001
         ) tsql_56389361563016958637_0000000002
       ) tsql_56389361563016958637_0000000003
       WHERE "row_number" <= 1
      ) tsql_56389361563016958637_0000000004
     ) tsql_56389361563016958637_0000000005
    ) tsql_56389361563016958637_0000000006 ORDER BY "subjectID"
