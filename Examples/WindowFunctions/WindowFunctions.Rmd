...
Note: we are not demonstrating `shift` in the `R` `SQLite` example. However the [`Python` `SQLite` example](https://github.com/WinVector/data_algebra/blob/master/Examples/WindowFunctions/WindowFunctions.md) does have include this function.
