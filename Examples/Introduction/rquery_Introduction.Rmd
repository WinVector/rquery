...
What we are trying to illustrate above: there is a continum of notations possible between:
...
Being able to see these as all related gives some flexibility in decomposing problems into solutions.  We have some more advanced notes on the differnces in working modalities [here](TODO: link to modes) and [here](TODO: link to arrows).
