...
The `R`/`rquery` version of this introuction is [here](https://github.com/WinVector/rquery/blob/master/Examples/Introduction/rquery_Introduction.md), and the `Python`/`data_algebra` version of this introduciton is [here](https://github.com/WinVector/data_algebra/blob/master/Examples/Introduction/data_algebra_Introduction.md).
