...
`rquery` operator are designed to check pre and post-conditions early.  This can be specialized into [interpreting `rquery` pipelines as category theory arrows](https://github.com/WinVector/rquery/blob/master/Examples/Arrow/Arrow.md).
